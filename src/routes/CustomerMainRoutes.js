...
import CustomerMainLayout from 'customerLayout/MainLayout';
import CustomerAuthGuard from 'utils/route-guard/CustomerAuthGuard ';

// render - dashboard
const DashboardDefault = Loadable(lazy(() => import('pages/dashboard/CustomerdefaultDashboard')));
const DashboardAnalytics = Loadable(lazy(() => import('pages/dashboard/CustomerAnalytics')));
...
const CustomerListUser = Loadable(lazy(() => import('pages/apps/customer/CustomerListUser')));
...
const AppInvoiceList = Loadable(lazy(() => import('pages/apps/invoice/listCustomer')));
