...
// project-imports
import AdminMainLayout from 'adminlayout/MainLayout';
import CommonLayout from 'layout/CommonLayout';
import Loadable from 'components/Loadable';
import AuthGuard from 'utils/route-guard/AuthGuard';
import AdminProfile from 'pages/apps/profiles/Admin';
import DepositorList from 'pages/apps/customer/DepositorsList';
// import CustomerListPage from 'pages/apps/customer/list';
import CustomerList from 'pages/apps/customer/CustomerList';

// render - dashboard
const DashboardDefault = Loadable(lazy(() => import('pages/dashboard/AdminDefaultDashboard')));
const DashboardAnalytics = Loadable(lazy(() => import('pages/dashboard/AdminAnalytics')));
...
const AppCustomerList = Loadable(lazy(() => import('pages/apps/customer/CustomerList')));
...
const EditAdminProfile = Loadable(lazy(() => import('sections/apps/profiles/user/EditAdminProfile')));
