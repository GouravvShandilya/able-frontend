                  ...
                  <Grid item xs={12}>
                    <Stack direction="row" justifyContent="space-around" alignItems="center">
                      ...
                      <Stack spacing={1} alignItems="center">
                        <Typography variant="h5">{data.invoice_id.length}</Typography>
                        <Typography color="secondary">Total invoices</Typography>
                      </Stack>
                    </Stack>
                  </Grid>
                  <Grid item xs={12}>
                      ...
                      <ListItem>
                        ...
                        <ListItemSecondaryAction>
                          <Typography align="right">
                            <PatternFormat displayType="text" format="+91 ### ### ####" mask="_" defaultValue={data.mobile_number} />
                          </Typography>
                        </ListItemSecondaryAction>
                      </ListItem>
                      <ListItem>
                        ...
                        <ListItemSecondaryAction>
                          <Typography align="left">{data.city + ' ' + data.country}</Typography>
                        </ListItemSecondaryAction>
                      </ListItem>
                      <ListItem></ListItem>
                    </List>
                  ...
                  <List sx={{ py: 0 }}>
                    ...
                    <ListItem>
                      <Stack spacing={0.5}>
                        ...
                        <Typography>{data.city + ' ' + data.state}</Typography>
                      </Stack>
                    </ListItem>
                  </List>
                </MainCard>
                <MainCard title="About me">
                  <Typography color="secondary">Hello, I’m {data.name}</Typography>
                </MainCard>
              </Stack>
            </Grid>
          </Grid>
