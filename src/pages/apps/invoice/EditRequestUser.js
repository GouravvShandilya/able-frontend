...
import { alertPopupToggle, getCollectionDelete, getEditReqList } from 'store/reducers/collectionUser';
...
const EditRequestUser = () => {
  ...
  useEffect(() => {
    dispatch(getEditReqList()).then(() => setLoading(false));
