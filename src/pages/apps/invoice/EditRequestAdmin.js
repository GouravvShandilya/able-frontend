...
import { alertPopupToggle, getCollectionDelete, getEditReqListAdmin } from 'store/reducers/collectionUser';
...
const EditRequestAdmin = () => {
  ...
  useEffect(() => {
    dispatch(getEditReqListAdmin()).then(() => setLoading(false));
            ...
            <Stack direction="row" alignItems="center" justifyContent="center" spacing={0}>
              <Tooltip title="Accept">
                <IconButton
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    console.log(row.values.invoice_id)
