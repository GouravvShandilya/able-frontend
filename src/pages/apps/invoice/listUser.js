...
import { alertPopupToggle, getCollectionDelete, getcollectionList } from 'store/reducers/collectionUser';
...
const ListUser = () => {
  ...
  useEffect(() => {
    dispatch(getcollectionList()).then(() => setLoading(false));
  ...
  const handleClose = (status) => {
    if (status) {
      dispatch(getCollectionDelete(invoiceId));
      dispatch(
        openSnackbar({
          open: true,
            ...
            <Stack direction="row" alignItems="center" justifyContent="center" spacing={0}>
              <Tooltip title="View">
                <IconButton
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    navigation(`/user/apps/invoice/details/${row.values.invoice_id}`);
                  }}
                >
                  <Eye />
                </IconButton>
              ...
              <Tooltip title="Edit">
                <IconButton
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    navigation(`/user/apps/invoice/edit/${row.values.invoice_id}`);
                  }}
                >
                  <Edit />
                </IconButton>
              ...
              <Tooltip title="Delete">
                <IconButton
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    setInvoiceId(row.values.invoice_id);
