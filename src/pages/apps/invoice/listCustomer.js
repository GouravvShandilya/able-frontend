...
import { getCustomerCollectionList } from 'store/reducers/collectionUser';
...
const ListCustomer = () => {
  ...
  useEffect(() => {
    dispatch(getCustomerCollectionList()).then(() => setLoading(false));
            ...
            <Stack direction="row" alignItems="center" justifyContent="center" spacing={0}>
              <Tooltip title="View">
                <IconButton
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    navigation(`/customer/apps/invoice/details/${row.values.invoice_id}`);
                  }}
                >
                  <Eye />
                </IconButton>
